...
public final class ActionKeyUtil {
    ...
    public static NamespacedKey getCommandKey(ClickType t) {
        if (t.isShiftClick()) {
            return t.isLeftClick() ? GUIManager.KEY_COMMAND_SHIFT_LEFT : GUIManager.KEY_COMMAND_SHIFT_RIGHT;
        }
    ...
    public static NamespacedKey getPermissionKey(ClickType t) {
        if (t.isShiftClick()) {
            return t.isLeftClick() ? GUIManager.KEY_PERMISSION_SHIFT_LEFT : GUIManager.KEY_PERMISSION_SHIFT_RIGHT;
        }
    ...
    public static NamespacedKey getItemCostKey(ClickType t) {
        if (t.isShiftClick()) {
            return t.isLeftClick() ? GUIManager.KEY_COST_SHIFT_LEFT : GUIManager.KEY_COST_SHIFT_RIGHT;
        }
    ...
    public static NamespacedKey getMoneyCostKey(ClickType t) {
        if (t.isShiftClick()) {
            return t.isLeftClick() ? GUIManager.KEY_MONEY_COST_SHIFT_LEFT : GUIManager.KEY_MONEY_COST_SHIFT_RIGHT;
        }
